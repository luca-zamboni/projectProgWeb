...
public class FrontController extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.err.println("gdhojnjdsdngjoosadgn");
        
        switch (op) {
            case "login":
                Support.forward(this.getServletContext(), request, response, JSPPATH + "index.jsp", null);
                break;
            case "logout":
                this.logout(request, response);
                break;
            case "register":
                Support.forward(this.getServletContext(), request, response, JSPPATH + "register.jsp", null);
                break;
            case "index":
                Support.forward(this.getServletContext(), request, response, JSPPATH + "home.jsp", null);
                break;
            case "profile":
                Support.forward(this.getServletContext(), request, response, JSPPATH + "profile.jsp", null);
                break;
            case "forgot":
            //todo
            default:
    ...
    private void logout(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
        ...
        response.sendRedirect(JSPPATH + "index.jsp");
    }//</editor-fold>
